...
<body style="background-color:#684551;color:#d5b0ac;margin:0px;">
    <div class="container">
        ...
        <form>
            ...
            <input class="form-control d-flex justify-content-between align-content-center" type="text" required="" placeholder="Edit Username" minlength="4" autofocus="" style="width:320px;margin:10px;">
            <input class="form-control d-flex justify-content-between align-content-center flex-wrap"
                    type="email" required="" placeholder="Edit Email" minlength="8" style="width:320px;margin:10px;"><input class="form-control" type="password" required="" placeholder="Edit Password" minlength="8" style="margin:10px;width:328px;">
            </div>
            <div class="form-group d-flex justify-content-center align-items-center"><a class="btn btn-primary" role="button" href="#">Update</a>
            </div>
        </form>
        <div class="row">
            <div class="col">
